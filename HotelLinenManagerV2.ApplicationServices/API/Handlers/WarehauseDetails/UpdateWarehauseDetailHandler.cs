...
{
    public class UpdateWarehauseDetailHandler : IRequestHandler<UpdateDetailsRequest, UpdateDetailsResponse>
    {
        private readonly ICommandExecutor commandExecutor;
        private readonly IQueryExecutor queryExecutor;
        private readonly IMapper mapper;

        public UpdateWarehauseDetailHandler(ICommandExecutor commandExecutor, IQueryExecutor queryExecutor, IMapper mapper)
        {
