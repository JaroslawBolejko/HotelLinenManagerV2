...
{
    public class GetAllWarehauseDetailHandler : IRequestHandler<GetAllDetailsRequest, GetAllDetailsResponse>
    {
        private readonly IMapper mapper;
        private readonly IQueryExecutor queryExecutor;

        public GetAllWarehauseDetailHandler(IMapper mapper,IQueryExecutor queryExecutor)
        {
            this.mapper = mapper;
