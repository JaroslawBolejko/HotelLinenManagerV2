...
//        public CreateCompanyValidator(/*IStartsWithDigit startsWithDigit, IZipCode zipCode*/)
//        {
...
//            //this.RuleFor(x => x.TaxNumber).NotEmpty().WithMessage("Podaj NIP!").MaximumLength(15)
//            //    .WithMessage("NIP składa się z 10 cyfr, bez znaków dodatkowych oraz oznaczeń kraju!");
...
//            ////this.RuleFor(x => x.ApartmentNumber).Must(this.startsWithDigit.DigitStarter).WithMessage("Numer lokalu musi zawierać cyfre")
...
//            ////    .Must(this.zipCode.IsPostalCode).WithMessage("zły format kodu!prawidłowy to xx-xxx, gdzie x - jest liczbą całkowitą.");
